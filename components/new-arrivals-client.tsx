  ...
  return (
    <div className="container py-8 px-4 md:px-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground text-pretty">Discover the latest fashion trends</p>
      </div>
      ...
      <p className="text-sm text-muted-foreground mb-4">
        Showing {paginatedProducts.length} of {filteredProducts.length} new arrivals
      </p>
      ...
      {paginatedProducts.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="text-muted-foreground">No new arrivals found matching your criteria.</p>
