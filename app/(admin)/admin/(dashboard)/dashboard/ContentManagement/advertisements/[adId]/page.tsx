    ...
    <div className="mx-4 my-2">
      <header className="p-2 flex items-center gap-4 mb-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground mt-1">ID: {adId}</p>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) => handleChange("click_target", value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
      ...
      {ad.ad_type !== "html" && (
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>
              Upload different images/videos for desktop, tablet, and mobile.
